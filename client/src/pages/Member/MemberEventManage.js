...
import SelectTime4 from '../../components/Soya/SelectTime4'
import SelectTime5 from '../../components/Soya/SelectTime5'
import SelectTime6 from '../../components/Soya/SelectTime6'
import {
  DateConvert,
  TimeConvert,
  ...
  useEffect(() => {
    Axios.get(
      ...
      .then(async (res) => {
        ...
        console.log(res.data[0].event_host_contact)
